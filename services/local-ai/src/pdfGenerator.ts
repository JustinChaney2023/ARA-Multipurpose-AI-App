...
export async function generateProfessionalPDF(
  ...
  y = drawNarrativeSection(page, pdfForm, 'Recipient & Visit Observations', 'observations', form.narrative.recipientAndVisitObservations, margin, y, boldFont);
  y -= 20;
  
  y = drawNarrativeSection(page, pdfForm, 'Health/Emotional Status', 'healthStatus', form.narrative.healthEmotionalStatus, margin, y, boldFont);
  y -= 20;
  
  y = drawNarrativeSection(page, pdfForm, 'Review of Services', 'servicesReview', form.narrative.reviewOfServices, margin, y, boldFont);
  y -= 20;
  
  y = drawNarrativeSection(page, pdfForm, 'Progress Toward Goals', 'goalsProgress', form.narrative.progressTowardGoals, margin, y, boldFont);
  y -= 20;
  
  y = drawNarrativeSection(page, pdfForm, 'Care Coordinator Follow Up Tasks', 'followUp', form.narrative.followUpTasks, margin, y, boldFont);
  y -= 20;
  
  y = drawNarrativeSection(page, pdfForm, 'Additional Notes', 'additionalNotes', form.narrative.additionalNotes, margin, y, boldFont);
  y -= 25;
...
function drawCareTypeSection(
  ...
  page.drawText('HCBW (Home and Community-Based Waiver)', { x: margin + 200, y: y - 2, size: 9, font: regularFont });
