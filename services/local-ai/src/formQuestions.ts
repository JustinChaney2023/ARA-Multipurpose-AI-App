...
export const FORM_QUESTIONS: FormQuestion[] = [
  ...
  },
  {
    ...
    context: "Look for the visit date. It may be labeled as 'Date:', 'Visit Date:', or mentioned in the opening. Format as MM/DD/YYYY if possible.",
    required: true,
    type: 'date',
  },
  {
  ...
  },
  {
    ...
    context: "Look for the location of the visit. May be labeled 'Location:', 'Where:', or mentioned as 'visited at home', 'office visit', 'phone call', etc.",
    required: false,
    type: 'text',
  },
  ...
  // Care Coordination Type (Checkboxes)
  {
    ...
    context: "Look for any mention of SIH, Senior In-Home, or in-home services for seniors. Check if [X] is marked next to SIH or if explicitly mentioned.",
    required: false,
    type: 'checkbox',
  },
  {
    ...
    context: "Look for any mention of HCBW, Home and Community-Based Waiver, waiver services. Check if [X] is marked next to HCBW or if explicitly mentioned.",
    required: false,
    type: 'checkbox',
  },
  ...
  // Narrative Sections - Simple prompts to avoid LLM confusion
  {
    ...
    question: "Describe the recipient and visit observations in detail based on the transcript. What was the client doing, how did they appear physically and mentally, what was the home environment like, who was present, and were there any concerns?",
    context: "Write a detailed paragraph describing what was observed during the visit. Include physical appearance, mental state, activities, home environment, people present, and any concerns. Use information from the transcript.",
    required: false,
    type: 'textarea',
  },
  {
    ...
    question: "What is the current health and emotional status based on the transcript? Include any medications, doctor visits, hospitalizations, falls, pain levels, vital signs, behavior changes, and mental health concerns.",
    context: "Write a detailed paragraph about health status. Include medical conditions, medications, doctor visits, hospitalizations, falls, vital signs, pain, behavior changes, and emotional state mentioned in the transcript.",
    required: false,
    type: 'textarea',
  },
  {
    ...
    question: "What services is the recipient currently receiving based on the transcript? Include personal care, nursing, therapy, equipment, transportation, and how well each service is working.",
    context: "Write a detailed paragraph about services being provided. Include personal care, nursing, therapy, equipment, transportation, service effectiveness, and any problems or changes mentioned in the transcript.",
    required: false,
    type: 'textarea',
  },
  {
    ...
    question: "How is the recipient progressing toward their goals based on the transcript? What are the specific goals, progress level, barriers, and any changes needed?",
    context: "Write a detailed paragraph about goals and progress. Include specific goals mentioned, progress made, barriers faced, and any changes needed based on information in the transcript.",
    required: false,
    type: 'textarea',
  },
  {
    ...
    question: "Are there any additional notes or important information not covered above based on the transcript? Include family dynamics, social concerns, financial issues, equipment needs, or other relevant details.",
    context: "Write a detailed paragraph with any other important information from the transcript. Include family dynamics, social factors, financial concerns, housing issues, equipment needs, or anything else relevant.",
    required: false,
    type: 'textarea',
  },
  {
    ...
    pdfField: 'followUp',
    question: "What follow-up tasks does the care coordinator need to complete based on the transcript? List specific actions, who to contact, and any deadlines.",
    context: "Write a detailed paragraph listing follow-up tasks. Include phone calls to make, appointments to schedule, services to arrange, paperwork to complete, and any deadlines mentioned in the transcript.",
    required: false,
    type: 'textarea',
  },
