          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ margin: '0 0 0.75rem', fontSize: '0.875rem', color: '#a16207' }}>
                You processed similar notes for <strong>{similarWarning.recipientName}</strong> on{' '}
                {formatDate(similarWarning.timestamp)}.
              </p>
              <button
                    ...
                    >
                      ...
                      >
                        <div style={{ flex: 1 }}>
                          ...
                          >
                            ...
                            <span
                              style={{
                                ...
                                borderRadius: '4px',
                                background: item.extractionMethod.includes('llm')
                                  ? '#dbeafe'
                                  : '#f1f5f9',
                                color: item.extractionMethod.includes('llm')
                                  ? '#1e40af'
                                  : '#64748b',
                              }}
                            >
                          ...
                          <p
                            style={{ margin: '0.25rem 0 0', fontSize: '0.75rem', color: '#94a3b8' }}
                          >
